...
TEST(system, transform_point_cloud)
{
  ...
  autoware_utils::transformPointCloud(cloud, cloud_transformed, transform);
...
TEST(system, empty_point_cloud)
{
  ...
  EXPECT_NO_THROW(autoware_utils::transformPointCloud(cloud, cloud_transformed, transform));
  EXPECT_NO_FATAL_FAILURE(autoware_utils::transformPointCloud(cloud, cloud_transformed, transform));
