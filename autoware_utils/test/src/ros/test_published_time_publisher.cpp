...
protected:
  ...
  std::shared_ptr<autoware_utils::PublishedTimePublisher> published_time_publisher_ptr_{nullptr};
  ...
  void SetUp() override
  {
    ...
    published_time_publisher_ptr_ =
      std::make_shared<autoware_utils::PublishedTimePublisher>(node_.get());
