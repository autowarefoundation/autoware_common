...
{
  using autoware_utils::getLongitudinalVelocity;
...
TEST(geometry, setOrientation)
{
  ...
  using autoware_utils::setOrientation;
...
{
  using autoware_utils::setLongitudinalVelocity;
...
TEST(geometry, point2tfVector)
{
  using autoware_utils::createQuaternionFromRPY;
  using autoware_utils::deg2rad;
  using autoware_utils::point2tfVector;
...
TEST(geometry, transformPose)
{
  using autoware_utils::createQuaternionFromRPY;
  using autoware_utils::deg2rad;
  using autoware_utils::transformPose;
...
TEST(geometry, inverseTransformPose)
{
  using autoware_utils::createQuaternionFromRPY;
  using autoware_utils::deg2rad;
  using autoware_utils::inverseTransformPose;
...
TEST(geometry, inverseTransformPoint)
{
  using autoware_utils::createQuaternionFromRPY;
  using autoware_utils::deg2rad;
  using autoware_utils::inverseTransformPoint;
  using autoware_utils::inverseTransformPose;
...
{
  using autoware_utils::calcInterpolatedPoint;
  using autoware_utils::createPoint;
  using autoware_utils::createQuaternion;
  using autoware_utils::createQuaternionFromRPY;
  using autoware_utils::deg2rad;
  using autoware_utils::isDrivingForward;
...
{
  using autoware_utils::calcInterpolatedPose;
  using autoware_utils::createPoint;
  using autoware_utils::createQuaternion;
  using autoware_utils::createQuaternionFromRPY;
  using autoware_utils::deg2rad;
...
{
  using autoware_utils::createVector3;
  ...
  // getTwist
  {
    auto t_out = autoware_utils::createTwist(velocity, angular);
...
TEST(geometry, getTwistNorm)
{
  ...
  twist_with_covariance.twist = geometry_msgs::build<geometry_msgs::msg::Twist>()
                                  ...
                                  .angular(createVector3(0.1, 0.2, 0.3));
  EXPECT_NEAR(autoware_utils::calcNorm(twist_with_covariance.twist.linear), 5.0, epsilon);
}
...
TEST(geometry, isTwistCovarianceValid)
{
  ...
  EXPECT_EQ(autoware_utils::isTwistCovarianceValid(twist_with_covariance), false);

  twist_with_covariance.covariance.at(0) = 1.0;
  EXPECT_EQ(autoware_utils::isTwistCovarianceValid(twist_with_covariance), true);
}
